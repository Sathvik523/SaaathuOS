...
export default function ControlCenterPopover({ isOpen, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="fixed top-9 right-3 z-50 w-80 rounded-2xl border border-white/10 bg-[#1E1F24]/85 p-3 text-white shadow-2xl backdrop-blur-3xl select-none animate-in fade-in zoom-in-95 duration-150">
